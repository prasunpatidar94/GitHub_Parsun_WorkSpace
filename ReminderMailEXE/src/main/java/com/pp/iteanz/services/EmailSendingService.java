...
//				msg.setRecipients(Message.RecipientType.TO, to);// anuj.surana@ssll.in
				...
				String htmlContent = "<html><body><font color=black>Hello,</b>" + "<br>" + "<br>" + body + "<br><br>"
...
public Boolean aprvMailNotification(String to, String subject, String body, String ccEmail) {
